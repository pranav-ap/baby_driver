...
class UltrafastLaneDetector:
    ...
    def detect_lanes(self, image, draw_points=True):
        ...
        # Draw depth image
        visualization_img = self.draw_lanes(
            image, self.lanes_points, self.lanes_detected, self.cfg, draw_points
        )

        return visualization_img, self.lanes_points[1], self.lanes_points[2]
